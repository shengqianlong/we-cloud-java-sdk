...
public class WeCloudSmsDomesticSingleSendRequest implements WeCloudRequest<WeCloudSmsDomesticSingleSendResponse> {

    private String apiVersion = "0.0.1";

    private WeCloudObject params;

    public WeCloudSmsDomesticSingleSendRequest(WeCloudObject params) {
        this.params = params;
    }

    @Override
    public String getApiMethodName() {
        return "we-cloud.sms.domestic.single.send";
    }
